...
A drug precursor molecule is extracted from a type of nut. The nuts are commonly contaminated by a fungal toxin that is difficult to remove during the purification process. We suspect that the amount of fungus (and hence toxin) depends on multiple factoors related to the growing site. 
...
This shows that there are `r nrow(toxin)` rows and `r ncol(toxin)` 
